...
public class LoginSteps extends CommonMethods{
	...
	//DashboardPageElements dash board;     ( we don't need anymore because it is inherited to pageInitializer)
    //           or 
	//   after setUp()
	...
	//	PageInitializer.initialize();    //this one is inside of the set up method
	...
	public void i_enter_a_valid_username() {
		...
		// sendText(PageInitializer.login.username, ConfigsReader.getProperty("username"));
	...
	public void enter_invalid_password() {
	 ...
	 public void validate_invalid_credentials_is_displayed() {
	...
	public void user_enters_username_and_password_and_clicks_on_the_login_button(DataTable dataTable) {
		...
		//click login  button
		//verify
		//log out   ---> sends us back to the login screen and ready for the next data to test
		...
		for (Map<String, String>  map : listOfMaps) {
			...
			//If you want take a screenshot here
